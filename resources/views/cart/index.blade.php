...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page-title { font-size: 18px; font-weight: 700; color: var(--text-dark); margin-bottom: 20px; }
        ...
        .select-all-label { font-size: 15px; font-weight: 700; color: var(--text-dark); }
        ...
        .item-name { font-size: 15px; font-weight: 600; color: var(--text-dark); margin-bottom: 4px; }
        ...
        .summary-title { font-size: 16px; font-weight: 700; color: var(--text-dark); margin-bottom: 20px; }
        ...
        .summary-row span:first-child { font-size: 15px; font-weight: 600; color: var(--text-dark); }
        .summary-row span:last-child { font-size: 16px; font-weight: 700; color: var(--text-dark); }
        ...
        .promo-input::placeholder { color: var(--pink); }
    ...
    <div class="cart-layout">
        ...
        <div class="cart-box">
            ...
            <div class="cart-item" id="item-{{ $item['product']->id }}">
                <input type="checkbox" class="custom-check item-check"
        ...
        <div class="summary-box">
            ...
            <input type="text" class="promo-input" placeholder="Promo">
            <button class="btn-beli" onclick="beliSekarang()">
                Beli(<span id="beli-count">{{ isset($cartItems) ? count($cartItems) : 0 }}</span>)
            </button>
        </div>
...
<script>
    ...
    // Ambil id produk pertama yang dipilih
